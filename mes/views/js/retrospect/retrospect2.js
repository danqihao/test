                            ...
                            ajaxData(){
                                $.ajax({
                                    ...
                                    success: (result, status, xhr) => {
                                        mesloadBox.hide()
                                        if(result.status === 0){
                                           this.workOrderList = result.map.workOrderList
                                                                ...
                                                                <div class="col-md-4">
                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                        ...
                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.planBatch">
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                        ...
                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.orderNumber">
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                        ...
                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.workOrderNumber">
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.finishName">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.finishNumber">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.founderStaffId" @click="staffSelect('founderStaffId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.responsibleStaffId" @click="staffSelect('responsibleStaffId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.verifierStaffId" @click="staffSelect('verifierStaffId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row" style="padding-top:10px">
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.orderCreatorsId" @click="staffSelect('orderCreatorsId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.orderResponsibleId" @click="staffSelect('orderResponsibleId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.workstageResponsibleId" @click="staffSelect('workstageResponsibleId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row" style="padding-top:10px">
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.materialUserId" @click="staffSelect('materialUserId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.materialPickId" @click="staffSelect('materialPickId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.materialRetreatId" @click="staffSelect('materialRetreatId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row" style="padding-top:10px">
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.dispatchStaffId" @click="staffSelect('dispatchStaffId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.productRecordId" @click="staffSelect('productRecordId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.scrapRecordId" @click="staffSelect('scrapRecordId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row" style="padding-top:10px">
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.operationOperatorId" @click="staffSelect('operationOperatorId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.rejectsRecordId" @click="staffSelect('rejectsRecordId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchStaffName.rejectsDisposeId" @click="staffSelect('rejectsDisposeId')">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.materielName">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.materielNumber">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.outofstorageBatch">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row" style="padding-top:10px">
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.materialenterBatch">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.bomName">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.bomVersion">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.craftName">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <form class="form-inline text-center" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="输入关键字" maxlength="25" v-model="searchData.craftVersions">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-5">
                                                                                    <form class="form-inline pull-left" action="" onsubmit="return false;">
                                                                                        ...
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="起始时间" maxlength="25" @blur="searchData.startTime = $event.target.value" onclick="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})">
                                                                                        </div>
                                                                                    </form>
                                                                                    <form class="form-inline pull-left" action="" onsubmit="return false;">
                                                                                        <label class="control-label">至</label>
                                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                                            <input class="form-control" type="text" placeholder="终止时间" maxlength="25" @blur="searchData.endTime = $event.target.value" onclick="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <tr v-for="(value,index) in workOrderList">
                                                                                                                ...
                                                                                                                <td class="table-input-td">
                                                                                                                    ...
                                                                                                                    <a class="table-link" href="./productionPlan.html" target="_blank"><i class="fa fa-pencil-square-o"></i>生产过程详情</a>
                                                                                                                </td>
                                                                                                            </tr>
                                                        ...
                                                        <div class="panel-body-table table-height" style="padding:5px">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-1 col-xs-2 text-center">
                                                                    <button class="btn btn-primary modal-submit" @click="searchs()">查询</button>
                                                                </div>
                                                            </div>
                                                            <div class="row" style="padding-top:10px">
                                                                <div class="col-md-3 col-xs-5">
                                                                ...
                                                                <div class="col-md-4 col-xs-6">
                                                                    <form class="form-inline pull-right" action="" onsubmit="return false;">
                                                                        ...
                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                            <input class="form-control" type="text" placeholder="终止时间" maxlength="25" @blur="searchsData.endTime = $event.target.value">
                                                                        </div>
                                                                    </form>
                                                                    <form class="form-inline pull-right" action="" onsubmit="return false;">
                                                                        <label class="control-label">时间：</label>
                                                                        <div class="input-group input-group-sm fuzzy-search-group">
                                                                            <input class="form-control" type="text" placeholder="起始时间" maxlength="25" @blur="searchsData.startTime = $event.target.value">
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                                <div class="col-md-1 col-xs-2 text-center">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr v-for="(value,index) in workOrderList">
                                                                        ...
                                                                        <td class="table-input-td">
                                                                            ...
                                                                            <a class="table-link" href="./productionPlan.html" target="_blank"><i class="fa fa-tasks fa-fw"></i>生产过程详情</a>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                    ...
                    let addFinalQualityReportModal = new Vue({
                        ...
                        created(){
                            ...
                            $.ajax({
                                ...
                                data: {
                                    reportId:'63bb2dff1ad44ec98f06c2ef1208c9e7'},
                                beforeSend: (xml) => {
                                    mesloadBox.loadingShow()
                                },
                                success: (result, status, xhr) => {
                                    ...
                                    success: (result, status, xhr) => {
                                        ...
                                        if(result.status === 0){
                                            result.map.reversePlanBatchs.forEach((val,key) => {
                                                val.workOrderShow = false
                                                this.reversePlanBatchs.push(val)
                                            })
                                        }else{
                                                                                                            ...
                                                                                                            <div class="panel-body-table table-height">
                                                                                                                <table class="table  table-bordered table-hover table-condensed">
                                                                                                                    ...
                                                                                                                    <tbody v-for="(value,index) in workstageList">
                                                                                                                        ...
                                                                                                                        <tr v-if="!workstageList.length"><td colspan=15 class="text-center text-warning">没有可以显示的数据，请重新选择或输入查询条件</td></tr>
                                                                                                                    </tbody>
                                                                                                                </table>
                                                                                                            </div>
                                                                                                            <div class="panel-footer panel-footer-table text-right">
                                                ...
                                                <table class="table table-bordered table-condensed">
                                                    <tbody>
                                                        ...
                                                        <tr v-for="(value,index) in planUseMaterialList">
                                                            ...
                                                            <td>{{value.plan_required_amount}}</td>
                                                            <td>{{value.warehouse_material_units}}</td>
                                                            <td>{{}}</td>
                                                            <td>{{}}</td>
                                                            <td class="table-input-td">
                                                                <a class="table-link" @click="materialDetails(value.craft_bom_material_id)" href="javascript:;"><i class="fa fa-tasks fa-fw"></i>物料详情</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                ...
                $.ajax({
                    ...
                    success: (result, status, xhr) => {
                        ...
                        if(result.status === 0){
                            ...
                            this.stageAndStepRelationList = result.map.workOrder.workstage.stageAndStepRelationList //工步
                            result.map.workOrder.workstage.useParametersList.forEach((value,index) => {  //参数
                                                ...
                                                <table class="table table-bordered table-condensed">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="width:19%">{{workOrderData.production_plan_batch_number}}</td>

                                                            <th style="width:14%">产品型号</th>
                                                            <td style="width:19%">{{workOrderData.product_model_name}}</td>
                                                        </tr>

                                                        <tr>
                                                            <th style="width:14%">工艺</th>
                                                            <td style="width:19%">{{workOrderData.craft_name}}</td>

                                                            <th style="width:14%">工艺版本</th>
                                                            <td style="width:19%">{{workOrderData.craft_versions}}</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:19%">{{workOrderData.workstage_quality_rate}}</td>

                                                            <th style="width:14%">工序负责人</th>
                                                            <td style="width:19%">{{workOrderData.workstage_responsible}}</td>

                                                            <th style="width:14%">极性</th>
                                                            <td style="width:19%">{{workOrderData.workstage_polarity}}</td>
                                                        </tr>

                                                        <tr>
                                                            <th style="width:14%">半成品类型</th>
                                                            <td style="width:19%">{{workOrderData.semi_finish_type_name}}</td>

                                                            <th style="width:14%">半成品型号</th>
                                                            <td style="width:19%">{{workOrderData.semi_finish_genre}}</td>

                                                            <th style="width:14%">产出量</th>
                                                            <td style="width:19%">{{workOrderData.product_element_batch_quantity}}</td>
                                                        </tr>

                                                        <tr>
                                                            <th style="width:14%">半成品单位</th>
                                                            <td style="width:19%">{{workOrderData.semi_finish_unit}}</td>

                                                            <th style="width:14%">生产线</th>
                                                            <td style="width:19%">{{workOrderData.product_line_name}}</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:19%">{{workOrderData.work_order_actual_finish_time | times}}</td>
                                                        ...
                                                        <tr>
                                                            <th style="width:14%">生产优先级</th>
                                                            <td style="width:19%">{{workOrderData.production_plan_production_priority}}</td>
        ...
        let materialModel = new Vue({
            ...
            methods:{
                ...
                oneDetails(){
                    $.ajax({
                        type: "POST", dataType: "json", xhrFields: { withCredentials: true }, crossDomain: true,
                        url: queryWorkOrderMaterialUseRecordUrl,
                        data: {
                            type:'norm',
                            workOrderId:id
                        },
            ...
            watch:{
                sort(val){
                    ...
                    if(this.sort === 'materialName'){
                        var data = 'materialName'
                    }else if(this.sort === 'materialUseTimeAsc'){
                        var data = 'materialUseTimeAsc'
                    }else if(this.sort === 'materialUseTimeDesc'){
                        var data = 'materialUseTimeDesc'
                    }
                    $.ajax({
                        type: "POST", dataType: "json", xhrFields: { withCredentials: true }, crossDomain: true,
                        url: queryWorkOrderMaterialUseRecordUrl,
            ...
            watch:{
                sort(val){
                    ...
                    if(this.sort === 'stepParameteName'){
                        var data = 'stepParameteName'
                    }else if(this.sort === 'parameteRecordTimeAsc'){
                        var data = 'parameteRecordTimeAsc'
                    }else if(this.sort === 'parameteRecordTimeDesc'){
                        var data = 'parameteRecordTimeDesc'
                    }
                    $.ajax({
                        type: "POST", dataType: "json", xhrFields: { withCredentials: true }, crossDomain: true,
                        url: queryWorkOrderStepParameteRecordUrl,
